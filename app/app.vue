  ...
  <div class="relative min-h-screen w-screen bg-black text-white overflow-hidden">
    <Transition name="splash-fade">
      <div v-if="showSplash" class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div ref="splineWrap" class="w-full h-full block relative">
          <!-- indicador mínimo (solo spinner, sin texto) -->
          <div
            v-show="!splineReady"
            class="absolute inset-0 z-20 flex items-center justify-center"
            aria-hidden="true"
          >
            <div class="w-10 h-10 border-4 border-white/20 rounded-full animate-spin"></div>
          </div>
      ...
      <div v-show="!showSplash">
        <ClientOnly v-if="isHomeRoute">
          <div class="absolute inset-0 z-0">
            <GlassStack ref="glassStack" class="w-full h-full" :projects="projects" :highlight-index="6" />
          </div>
        </ClientOnly>
      
        <!-- contenido de página (forzamos remount con key) -->
...
const projects = ref([
  ...
  { id: 'glass-industrial',title: 'Vidrio Industrial',imageSmall: '/images/reloj-small.webp', image: '/images/camara2.webp', century: 'S. XVIII', href: '/glass/escaparate-vs-publicidad' },
  { id: 'glass-catalogue', title: 'Catálogo Vítreo',  imageSmall: '/images/reloj-small.webp', image: '/images/cristal1.webp', century: 'S. XIX', href: '/glass/espejos-reflejo-social' },
  { id: 'glass-modern',    title: 'Vidrio Moderno',   imageSmall: '/images/reloj-small.webp', image: '/images/cristal2.webp', century: 'S. XX', href: '/glass/otro-mas' },
])
...
canvas { display: block; width: 60%; height: 60%; }
[spline-viewer] { width: 60%; height: 60%; display: block; }
</style>
