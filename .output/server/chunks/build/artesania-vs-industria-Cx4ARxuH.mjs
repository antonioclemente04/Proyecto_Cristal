...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative artesania-industria min-h-screen bg-red-900 text-white" }, _attrs))} data-v-cb00f61e><header class="fixed top-2.5 left-0 right-0 px-6 md:px-10 py-5 flex items-center justify-between z-10" data-v-cb00f61e><a href="/?nosplash=1" class="text-xs md:text-[1.3em] font-bold uppercase" data-v-cb00f61e>GLASS LAB\xAE</a></header><main class="relative z-10 px-6 md:px-12 max-w-5xl mx-auto" data-v-cb00f61e><section class="min-h-[calc(108dvh-64px)] flex items-center justify-center hero-section relative left-1/2 -translate-x-1/2 w-screen" data-v-cb00f61e>`);
      if (mounted.value) {
...
export { artesaniaVsIndustria as default };
//# sourceMappingURL=artesania-vs-industria-Cx4ARxuH.mjs.map
