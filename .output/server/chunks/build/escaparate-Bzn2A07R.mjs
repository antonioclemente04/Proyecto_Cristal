  ...
  setup(__props) {
    const products = [
      ...
      },
      {
        ...
        description: "Televisor de tubo de los a\xF1os 60",
        price: 100,
        stock: 1,
    ...
    const messages = [
      ...
      "La publicidad tradicional respetaba los l\xEDmites del espacio personal",
      "showImagePanel",
      "Hab\xEDa una comunicaci\xF3n bidireccional, m\xE1s personal con lo que se observaba",
      "La televisi\xF3n ya trajo consigo una dr\xE1stica invasi\xF3n de la publicidad en nuestras vidas",
    ...
    ref([
      { emoji: "\u{1F6CD}\uFE0F", text: "Ofertas en tu tienda favorita" },
      { emoji: "\u2708\uFE0F", text: "Vuelos a destinos buscados" },
      { emoji: "\u{1F4F1}", text: "El \xFAltimo smartphone" },
      { emoji: "\u{1F45F}", text: "Zapatillas que viste" }
    ]);
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (showImagePanel.value) {
        ...
        ssrRenderList(products, (product, index) => {
          ...
          if (((_a = selectedProduct.value) == null ? void 0 : _a.id) === product.id) {
...
export { escaparate as default };
//# sourceMappingURL=escaparate-Bzn2A07R.mjs.map
