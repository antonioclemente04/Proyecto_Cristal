...
const _imports_1 = publicAssetsURL("/images/est\xE1tica.mp4");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const introMessages = [
      "Antes, el vidrio nos permit\xEDa ver el mundo a trav\xE9s de las ventanas...",
      "Las imponentes catedrales nos muestran como una ventana era capaz de embellecer la realidad",
      "En el pasado se exploraron nuevas formas de mirar a trav\xE9s",
    ...
    const reflectionMessages = [
      ...
      "Nuestra atenci\xF3n se divide entre m\xFAltiples ventanas...",
      "El mundo se ha vuelto una red de pantallas interconectadas...",
      "\xBFD\xF3nde termina la realidad y d\xF3nde comienza la representaci\xF3n?"
    ];
...
export { Pantallas as default };
//# sourceMappingURL=Pantallas-C7-1tG5W.mjs.map
