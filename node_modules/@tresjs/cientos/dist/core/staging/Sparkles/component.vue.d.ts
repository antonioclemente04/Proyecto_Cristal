...
declare const _default: import('vue').DefineComponent<SparkleProps, {
    instance: Points<BufferGeometry<import('three').NormalOrGLBufferAttributes, import('three').BufferGeometryEventMap>, ShaderMaterial, import('three').Object3DEventMap>;
