  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (showGlass.value) {
        ...
        _push(`</div></div></div><div class="instructions select-none" data-v-ac88fd82> Mueve el ratón para ver el efecto de refracción </div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
//# sourceMappingURL=espejo-BTjonD8N.js.map
